...
import info.worker.Worker_Actor_2;
...
public class Peer_2 extends UntypedActor {
    private static int start = 1;
    private static int end = 0;
    private static MqttClient peer2 = null;
    ...
    public void preStart(){ //what to do when this worker is created and started
        ...
        String clientId = "ChaudharyPeer_2";  //Client ID

        log.info("Peer2 Boss Actor starting");

        try{
            //Create an object of MqttClient that is used to communicate with Mqtt broker
            peer2 = new MqttClient(broker, clientId, new MemoryPersistence());
            ...
            peer2.connect(conOptions);


            peer2.subscribe("/DS341/TaskTo/Chaudhary/Client", 1); //subscribe the topic
            System.out.println("Subscribed");
            System.out.println("Listening");

            //set callback listener to use for event that happens asynchronously
            peer2.setCallback(new MqttCallback() {
                ...
                public void messageArrived(String topic, MqttMessage message) throws Exception {
                    ...
                    while(start < end) {
                        ...
                        String path = "/Users/indeshwarchaudhary/Desktop/myfile/data_2/file" + fileNo + ".csv"; //path of the file
                        ...
                        ActorRef worker = getContext().actorOf(Props.create(Worker_Actor_2.class), w); //create a worker
    ...
    public void onReceive(Object message) throws MqttException {  //what to do when message is received
        if(message instanceof JSONObject){
            ...
            if(!((JSONObject) message).isEmpty()) { //if the message is not empty, do the following task
                ...
                peer2.publish("/DS341/ResultFrom/Chaudhary/peer2", msg);      //publish the message
